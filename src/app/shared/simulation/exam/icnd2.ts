...
const sw1_gi0_0 = new GigabitEthernet();
...
const sw1_gi0_1 = new GigabitEthernet();
sw1_gi0_1.slot = 0;
sw1_gi0_1.port = 1;
...
const sw1_gi0_2 = new GigabitEthernet();
sw1_gi0_2.slot = 0;
sw1_gi0_2.port = 2;
...
const sw1_gi0_3 = new GigabitEthernet();
sw1_gi0_3.slot = 0;
sw1_gi0_3.port = 3;
...
const sw1_gi1_0 = new GigabitEthernet();
sw1_gi1_0.slot = 1;
sw1_gi1_0.port = 0;
...
const sw1_gi1_1 = new GigabitEthernet();
sw1_gi1_1.slot = 1;
sw1_gi1_1.port = 1;
...
const sw1_gi1_2 = new GigabitEthernet();
sw1_gi1_2.slot = 1;
sw1_gi1_2.port = 2;
...
const sw1_gi1_3 = new GigabitEthernet();
sw1_gi1_3.slot = 1;
sw1_gi1_3.port = 3;
...
const sw1_gi2_0 = new GigabitEthernet();
sw1_gi2_0.slot = 2;
sw1_gi2_0.port = 0;
...
const sw1_gi2_1 = new GigabitEthernet();
sw1_gi2_1.slot = 2;
sw1_gi2_1.port = 1;
...
const sw1_gi2_2 = new GigabitEthernet();
sw1_gi2_2.slot = 2;
sw1_gi2_2.port = 2;
...
const sw1_gi2_3 = new GigabitEthernet();
sw1_gi2_3.slot = 2;
sw1_gi2_3.port = 3;
...
const sw1_gi3_0 = new GigabitEthernet();
sw1_gi3_0.slot = 3;
sw1_gi3_0.port = 0;
...
const sw1_gi3_1 = new GigabitEthernet();
sw1_gi3_1.slot = 3;
sw1_gi3_1.port = 1;
...
const sw1_gi3_2 = new GigabitEthernet();
sw1_gi3_2.slot = 3;
sw1_gi3_2.port = 2;
...
const sw1_gi3_3 = new GigabitEthernet();
sw1_gi3_3.slot = 3;
sw1_gi3_3.port = 3;
...
const sw2_gi0_0 = new GigabitEthernet();
sw2_gi0_0.slot = 0;
sw2_gi0_0.port = 0;
...
const sw2_gi0_1 = new GigabitEthernet();
sw2_gi0_1.slot = 0;
sw2_gi0_1.port = 1;
...
const sw2_gi0_2 = new GigabitEthernet();
sw2_gi0_2.slot = 0;
sw2_gi0_2.port = 2;
...
const sw2_gi0_3 = new GigabitEthernet();
sw2_gi0_3.slot = 0;
sw2_gi0_3.port = 3;
...
const sw2_gi1_0 = new GigabitEthernet();
sw2_gi1_0.slot = 1;
sw2_gi1_0.port = 0;
...
const sw2_gi1_1 = new GigabitEthernet();
sw2_gi1_1.slot = 1;
sw2_gi1_1.port = 1;
...
const sw2_gi1_2 = new GigabitEthernet();
sw2_gi1_2.slot = 1;
sw2_gi1_2.port = 2;
...
const sw2_gi1_3 = new GigabitEthernet();
sw2_gi1_3.slot = 1;
sw2_gi1_3.port = 3;
...
const sw2_gi2_0 = new GigabitEthernet();
sw2_gi2_0.slot = 2;
sw2_gi2_0.port = 0;
...
const sw2_gi2_1 = new GigabitEthernet();
sw2_gi2_1.slot = 2;
sw2_gi2_1.port = 1;
...
const sw2_gi2_2 = new GigabitEthernet();
sw2_gi2_2.slot = 2;
sw2_gi2_2.port = 2;
...
const sw2_gi2_3 = new GigabitEthernet();
sw2_gi2_3.slot = 2;
sw2_gi2_3.port = 3;
...
const sw2_gi3_0 = new GigabitEthernet();
sw2_gi3_0.slot = 3;
sw2_gi3_0.port = 0;
...
const sw2_gi3_1 = new GigabitEthernet();
sw2_gi3_1.slot = 3;
sw2_gi3_1.port = 1;
...
const sw2_gi3_2 = new GigabitEthernet();
sw2_gi3_2.slot = 3;
sw2_gi3_2.port = 2;
...
const sw2_gi3_3 = new GigabitEthernet();
sw2_gi3_3.slot = 3;
sw2_gi3_3.port = 3;
...
const fs_gi0_0 = new GigabitEthernet();
fs_gi0_0.slot = 0;
fs_gi0_0.port = 0;
...
const R1_gi0_1 = new GigabitEthernet();
R1_gi0_1.slot = 0;
R1_gi0_1.port = 1;
...
// :: START OF VLAN :: //
const SW1_vlan_1 = new Vlan();
SW1_vlan_1.id = 1;
SW1_vlan_1.name = 'default';
SW1_vlan_1.status = 'active';
SW1_vlan_1.spanningEnabled = true;
SW1_vlan_1.ports = [sw1_gi0_1.interface, sw1_gi0_2.interface, sw1_gi0_3.interface, sw1_gi1_2.interface,
                    sw1_gi1_3.interface, sw1_gi2_1.interface, sw1_gi2_2.interface, sw1_gi2_3.interface,
                    sw1_gi3_0.interface, sw1_gi3_1.interface, sw1_gi3_2.interface, sw1_gi3_3.interface];
SW1_vlan_1.SAID = '100001';
SW1_vlan_1.type = 'enet';
SW1_vlan_1.MTU = '1500';

const SW1_vlan_10 = new Vlan();
SW1_vlan_10.id = 10;
...
// :: Switch 2 :: //
const SW2_vlan_1 = new Vlan();
SW2_vlan_1.id = 1;
SW2_vlan_1.name = 'default';
SW2_vlan_1.spanningEnabled = true;
SW2_vlan_1.ports = [sw2_gi0_3.interface, sw2_gi1_3.interface, sw2_gi2_0.interface, sw2_gi2_1.interface,
                    sw2_gi2_2.interface, sw2_gi2_3.interface, sw2_gi3_0.interface, sw2_gi3_1.interface,
                    sw2_gi3_2.interface, sw2_gi3_3.interface];
SW2_vlan_1.SAID = '100001';
SW2_vlan_1.type = 'enet';

const SW2_vlan_10 = new Vlan();
SW2_vlan_10.id = 10;
...
// :: START OF DEVICES :: //
const sw1 = new Device();
sw1.name = 'SW1';
sw1.subtype = 'IOSvL2';
sw1.address = 'fa16.2ec7.4863';
sw1.interfaces = [sw1_gi0_1, sw1_gi0_2, sw1_gi0_3, sw1_gi0_0,
                    sw1_gi1_0, sw1_gi1_1, sw1_gi1_2, sw1_gi1_3,
                    sw1_gi2_0, sw1_gi2_1, sw1_gi2_2, sw1_gi2_3,
                    sw1_gi3_0, sw1_gi3_1, sw1_gi3_2, sw1_gi3_3, sw1_lo_0];
sw1.vlans = [SW1_vlan_1, SW1_vlan_10, SW1_vlan_20, SW1_vlan_30,
            SW1_vlan_1002, SW1_vlan_1003, SW1_vlan_1004, SW1_vlan_1005];
sw1.vtpConfig = sw1_gi0_0.interface;
sw1.vtp.domain = 'ACME';
sw1.vtp.mode = 'transparent';

const sw2 = new Device();
sw2.name = 'SW2';
sw2.subtype = 'IOSvL2';
sw2.address = 'fa16.3e18.41a2';
sw2.interfaces = [sw2_gi0_1, sw2_gi0_2, sw2_gi0_3, sw2_gi0_0,
                    sw2_gi1_0, sw2_gi1_1, sw2_gi1_2, sw2_gi1_3,
                    sw2_gi2_0, sw2_gi2_1, sw2_gi2_2, sw2_gi2_3,
                    sw2_gi3_0, sw2_gi3_1, sw2_gi3_2, sw2_gi3_3, sw2_lo_0];
sw2.vlans = [SW2_vlan_1, SW2_vlan_10, SW2_vlan_20, SW2_vlan_30,
            SW2_vlan_40, SW2_vlan_1002, SW2_vlan_1003, SW2_vlan_1004, SW2_vlan_1005];
...
const devices: Device[] = [sw1, sw2, server, r1];
...
const jsonData: ITopology = topology.serialize(true) as ITopology;
